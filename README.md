...
- Inspect `deploy.sh` and add a short usage header and header comment.
- Add a `--dry-run` implementation to the script.
- Generate a GitHub Actions workflow that runs linting and optionally calls the script in a safe way.
